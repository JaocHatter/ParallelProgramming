...
public class QR_Paralelo {
    public static final int HILOS = 3;
    //--------------------------------------------------------------
...
Tools.PrintMatrixToHTML(A.returnMatrix(),"Matriz Q-html","Matriz_Q_html");
}
}
